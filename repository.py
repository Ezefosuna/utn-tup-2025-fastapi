...
accessing Persona and Pais entities from the database using SQLModel.
"""
...
class PersonaRepositoryInterface(ABC):
    """Interface for Persona repository pattern."""
...
class PersonaRepository(PersonaRepositoryInterface):
    ...
    def create(self, persona: PersonaCreate) -> Persona:
        ...
        Args:
            persona: Person data to create
        
        Returns:
            Persona: Created person
        """
    ...
    def get_by_id(self, persona_id: int) -> Optional[Persona]:
        ...
        Returns:
            Optional[Persona]: Person if found, None otherwise
        """
