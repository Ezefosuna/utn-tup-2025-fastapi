"""Data models for Persona and Pais entities.

This module defines SQLModel models for database tables and Pydantic
...
class PersonaBase(SQLModel):
    ...
    pais_id: Optional[int] = Field(
        default=None, foreign_key="pais.id", description="ID del país"
    )
