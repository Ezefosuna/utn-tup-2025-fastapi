"""Paises router for country management endpoints.

This module provides API endpoints for:
- Creating countries
- Listing countries with pagination
- Retrieving specific country details
...
router = APIRouter(prefix="/paises", tags=["Countries"])
...
def get_paises(
    ...
    limit: int = Query(100, ge=1, le=1000, description="Number of countries to return"),
    repo: PaisRepository = Depends(get_pais_repository)
) -> List[PaisResponse]:
    ...
    Returns:
        List[PaisResponse]: List of countries
    """
