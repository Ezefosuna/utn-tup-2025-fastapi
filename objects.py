"""Objects router for generic object management endpoints.

This module provides a simple in-memory API for managing objects with:
...
Note: Objects are stored in-memory and will be lost on application restart.
For production use, consider using a database backend.
"""
...
# Global array with objects data (in-memory storage)
objects_data = [
    {
        "id": "1",
